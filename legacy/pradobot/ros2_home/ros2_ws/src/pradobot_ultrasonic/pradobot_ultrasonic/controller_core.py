...
#awoke leverage freezing machine
...
class ControlNode(Node):
    ...
    def listener_callback(self, msg):
        ...
        control_message = f"{msg.axes[L_JOY_HORIZONTAL]*self.active_mode},{msg.axes[L_JOY_VERTICAL]*self.active_mode},{int(self.high_speed_mode)}\n".encode("utf-8")
